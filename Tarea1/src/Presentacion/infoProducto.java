    ...
    private void initComponents() {
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addComponent(listo, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap())
        );
        ...
        if(fila==-1){
            ...
            if (MP.findProducto(nombre).getClass().getSimpleName().equals("Individual")){
                ...
                Foto.setIcon( icono );
                    ...
                    if (dp.getActiva()){
                        this.activa.setSelected(true);
                    }else{
                        this.activa.setSelected(false);
                    }
