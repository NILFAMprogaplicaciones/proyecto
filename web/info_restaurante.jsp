...
<!-- Page Content -->
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-9">
                <div class="row" id="CuadriculaRestaurantes"> </div>                   
                </div>
            </div>
        </div>
   <!--  </div> -->
            ...
            var $CuadriculaRestaurantes = $('#CuadriculaRestaurantes');                           // Locate HTML DOM element with ID "someselect".
                $.each(responseJson, function(key, value) {               // Iterate over the JSON object.                        
                 $('<div class="col-sm-4 col-lg-4 col-md-4">\n\
                    <div class="thumbnail"><img src="http://placehold.it/320x150" \n\
                    alt=""><div class="caption"><h4><a href="ver_restaurante.jsp">'+key+'\
</a></h4></div><div class="ratings"><p class="pull-right">15 reviews</p><p><span class="glyphicon glyphicon-star"></span><span class="glyphicon glyphicon-star"></span><span class="glyphicon glyphicon-star"></span><span class="glyphicon glyphicon-star"></span><span class="glyphicon glyphicon-star"></span></p></div></div></div>').appendTo($CuadriculaRestaurantes);                            
